                ...
                <form action="<?= base_url('interview/add'); ?>" method="post">
                    <div class="ibox-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" pattern="[0-9]" name="salary" id="salary" class="form-control" placeholder="Masukkan angka saja" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                        </div>
                        <div class="form-group row">
